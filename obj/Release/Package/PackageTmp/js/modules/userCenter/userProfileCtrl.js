...
define(['uploadFile', 'userCenterService', 'fileService','formValidate'], function (uploader, userCenterService, fileService, form) {
    ...
    uploader.uploadify($('#upload-portrait'), uploadUrl, onUploadSuccess);
...
function GetValue(myProfile, type) {
    ...
    //$('#g_Country').html(GetValueStr(myProfile['Country']));
    //$('#g_Position').html(GetValueStr(myProfile['Position']));
    $('#g_Gender').html(utility.parseGenderByIdCardNo(myProfile['IdCardNo']));
    $('#g_Birthday').html(myProfile['Birthday'] == null ? '' : new Date(myProfile['Birthday']).toLocaleDateString().replace(/\//g, "-"));
    ...
    //$('#Country').val(GetValueStr(myProfile['Country']));
    //$('#Position').val(GetValueStr(myProfile['Position']));
    $('#up_Gender').val(utility.parseGenderByIdCardNo(myProfile['IdCardNo']));
    //$('#CellNumber').val(GetValueStr(myProfile['CellNumber']));
    $('#up_Birthday').val(myProfile['Birthday'] == null ? '' : new Date(myProfile['Birthday']).toLocaleDateString().replace(/\//g, "-"));
    ...
    //$('.myHead').css('background-image', 'url('+ myProfile['PortraitUri'] + ')');
